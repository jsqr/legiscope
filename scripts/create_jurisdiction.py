...
Examples:
  ...
  %(prog)s IL Chicago --verbose
    ...
    parser.add_argument("state", help="Two-letter state abbreviation (e.g., NY, CA, IL)")
    parser.add_argument("municipality", help="Municipality name (e.g., New York, LosAngeles)")
