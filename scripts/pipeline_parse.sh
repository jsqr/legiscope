...
echo "Parsing legal code: state=$STATE municipality=$MUNICIPALITY code=$CODE_SLUG..."
...
echo "  2. Run: make process STATE=$STATE MUNICIPALITY=${MUNICIPALITY} CODE_SLUG=$CODE_SLUG"
